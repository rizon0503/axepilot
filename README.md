...
- Process, workflow, and safety rules for contributors (human or AI): [RULES.md](RULES.md) — the canonical source; every AI-tool instruction file (`CLAUDE.md`, `AGENTS.md`, `.github/copilot-instructions.md`, etc.) is a thin pointer to it
