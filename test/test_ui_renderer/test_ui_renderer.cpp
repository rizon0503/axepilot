...
void test_render_telemetry_draws_all_fields() {
    ...
    TEST_ASSERT_EQUAL_STRING("Err: 1.2%", display.lastTextAt(10, 125)->text.c_str());
...
void test_render_telemetry_shows_error_rate_red_above_threshold() {
    ...
    TEST_ASSERT_EQUAL_STRING("Err: 5.1%", display.lastTextAt(10, 125)->text.c_str());
    TEST_ASSERT_EQUAL(Colors::RED, display.lastTextAt(10, 125)->color);
}
